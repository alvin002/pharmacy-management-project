...
namespace PHARMACY
{
    public partial class CashierCashSaleWindow : Form
    {
        DataTable dt;
        DataTable dtdelete = new DataTable();
       
        public CashierCashSaleWindow(String mess, string firstname,string lastname)
        {
            InitializeComponent();
        ...
        {
            string db = "datasource=localhost; port=3306; username=root; password=; database=pms";
        ...
        private void CashierCashSaleWindow_Load(object sender, EventArgs e)
        {
