...
namespace PHARMACY.PrintingControl
{
    class printReceipt
    {
        ...
        public void createReceipt(object sender,System.Drawing.Printing.PrintPageEventArgs events) {
            con.Open();
            MySqlCommand command = new MySqlCommand("SELECT drug_name AS 'DRUG NAME',quantity AS 'QTY',price AS 'PRICE',quantity*price AS 'TOTAL',unit AS 'UNITS' FROM cart ORDER BY cart_id ASC"
                );
