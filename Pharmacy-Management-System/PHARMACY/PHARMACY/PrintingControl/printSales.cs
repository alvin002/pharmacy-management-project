...
namespace PHARMACY.PrintingControl
{
    class printSales
    {
        ...
        public void CreateReceipt(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            MySqlCommand com = new MySqlCommand("SELECT sales_id AS 'ID', drug_name AS 'DRUG NAME',quantity AS 'QUANTITY',price AS 'PRICE', pfno AS 'SERVED BY',sales_date AS 'DATE SOLD',unit AS 'UNITS', serial AS 'RECEIPT NUMBER' FROM sales ORDER BY sales_date ASC"
                                                );
